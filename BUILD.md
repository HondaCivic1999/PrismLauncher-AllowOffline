...
```
git clone --recursive https://github.com/HAMM3REXTREME/PrismLauncher-AllowOffline
cd PrismLauncher-AllowOffline
```
...
## Additional notes:
- Does not work with Java 20. Please use Java 17.
- Make sure you have all the dependencies installed (On Arch: extra-cmake-modules, ghc-filesystem etc.).
- Refer to the [AUR package](https://aur.archlinux.org/packages/prismlauncher-git?all_deps=1#pkgdeps) for more details. 
